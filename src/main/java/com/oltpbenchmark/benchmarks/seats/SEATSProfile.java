...
public class SEATSProfile {
  ...
  /**
   * For each airport id, store the last id of the customer that uses this airport as their local
   * airport. The customer ids will be stored as follows in the dbms: <16-bit AirportId><48-bit
   * CustomerId>
   */
  ...
  /**
   * The number of days in the future (from the flight_upcoming_date) that our flight data set
   * includes
   */
  ...
  /**
   * Depart Airport Code -> Arrive Airport Code Random number generators based on the flight
   * distributions
   */
